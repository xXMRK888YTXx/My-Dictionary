...
import com.xxmrk888ytxx.mydictionary.glue.EditWordScreen.RemovePhrasesContractImpl
...
interface EditWordScreenModule {
    ...
    @Binds
    fun bindRemovePhrasesContract(
        RemovePhrasesContractImpl: RemovePhrasesContractImpl
