...
class OpenWhereGetTelegramDataSiteUseCaseImpl @Inject constructor(
    ...
    override fun execute() {
        try {
            val url = context.getString(R.string.where_get_telegram_data_url)
    ...
    companion object {
        private const val LOG_TAG = "OpenWhereGetTelegramDataSiteUseCaseImpl"
    }
}